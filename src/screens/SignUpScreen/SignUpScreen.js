/**
    ...
    * - Modification    : 
**/
import { View,  Image,Text, StyleSheet, ScrollView, useWindowDimensions, Alert, Modal} from 'react-native'
      ...
      <ScrollView showsVerticalScrollIndicator={true}>
        ...
        <View style={styles.parentRoot}>
          ...
          <CustomInput 
            ...
            <Text style={styles.text}>
              Have an account? {' '}
              <Text style={styles.link} onPress={onSignInPress}>Sign in</Text> 
            </Text>
